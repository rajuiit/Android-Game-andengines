...
public class MainActivity extends BaseGameActivity {
	...
	public void onLoadResources() {
		...
		this.mBananaTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mBananaAtlas, MainActivity.this, "helicopter_tiled.png", 0, 0, 2, 2);// for animated sprite
	...
	public Scene onLoadScene() {
		...
		mBanana.animate(new long[] { 100, 100}, 1, 2, true);
