...
public class MainActivity extends BaseGameActivity {
	...
	public Scene onLoadScene() {
		...
		this.mScene.attachChild(new Text(160, 120, this.mKingdomOfHeartsFont, "Kingdom Of Hearts Font"));
		this.mScene.attachChild(new Text(110, 210, this.mNeverwinterNightsFont, "Neverwinter Nights Font"));
		this.mScene.attachChild(new Text(140, 300, this.mPlokFont, "Plok Font"));
		this.mScene.attachChild(new Text(25, 390, this.mUnrealTournamenFont, "Unreal Tournament Font"));
