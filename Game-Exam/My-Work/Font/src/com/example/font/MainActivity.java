...
public class MainActivity extends BaseGameActivity {
	...
	public Scene onLoadScene() {
		...
		this.mText = new Text(0, 0, mFont, "Hello World");
		this.mScene.attachChild(this.mText);
		
		// this is ChangeableText i.e  upgradable
		this.mChangeableText = new ChangeableText(150, 250, mFont, "Hell",200);
		this.mScene.attachChild(this.mChangeableText);
		this.mChangeableText.setText("This is Droid font");
